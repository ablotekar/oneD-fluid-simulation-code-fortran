...
!-------------------------------------------------------
      ...
      DNEH     = 0D-2      ! Amplitude of perturbation in HOT electron density
      L0EH     = 5D0        ! Perturbation widht for COLD electron 

      DNEC     = 0D-2         ! Amplitude of perturbation in electron density
      L0EC     = 5D0        ! Perturbation widht for electron       

      DNI      = 0D-2        ! Amplitude of perturbation in ion density
      L0I      = 5D0        ! Perturbation widht for ion 

      DNV      = 0D-2         ! Amplitude of perturbation in ion velocity
      L0V      = 2D0        ! Perturbation widht for ion velocity
                                              
      TIDATA   = 10      ! time interval of data save
      NTIME    = 10     ! time of simulation
...
! ----------- peruturbation choice ---------------------------
      PRC      = 2        ! 1 = Gaussian perturbation 
                         ! 2 = Step function perturbation 
!------------------------------------------------------------- 

! -------------- Data save options ---------------------------------                         
      CC       = 2          ! 1 = data save in vector (1 X N) formate
