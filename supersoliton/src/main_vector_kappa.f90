...
!---- Giving initla value --------------------------------------------- 
      PH(2,:) = PH(1,:)
! --- Poisson solveer -------------------------------------------------  
      CALL POISSON_SOL_KAPPA(PH(2,:), NI(2,:))
!---- FILTERING -------------------------------------------------------        
      CALL FILTERn(PH(2,:))
!
...
!---- Giving initla value --------------------------------------------- 
      PH(1,:) = PH(2,:)
!   
      CALL POISSON_SOL_KAPPA(PH(1,:), NI(1,:))
!---- FILTERING -------------------------------------------------------        
      CALL FILTERn(PH(1,:))
   ...
   99 CONTINUE
      ...
      END SUBROUTINE main_vector_kappa 
