...
inputfile = open("./Input.txt", "r")    # Reading input file

dxstr = readline_number_x(inputfile, 2)  # Reading dx 
dx = float(dxstr[9:14])                  # Converting string to float 

dtstr = readline_number_x(inputfile, 1)  # Reading dt 
dt = float(dtstr[9:15])                  # Converting string to float
...
fname = filelist[len(filelist)-1]  # Recent file name 
